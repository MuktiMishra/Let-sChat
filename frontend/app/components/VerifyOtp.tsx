...
const VerifyOtp = () => {
    ...
    const [resendLoading , setResentLoading] = useState(false);
    ...
    }, [timer]);  //=> jab jab timer me change hoga useEffect call hoga
    console.log(timer);
      ...
      <div className='max-w-md w-full'>
        <div className='bg-gray-800 border border-gray-700 rounded-lg p-8'>
            <div className='text-center mb-8 relative'>
              <button className='absolute top-0 left-0 p-2 text-gray-300' onClick={()=> router.push("/login")}>
                <ChevronLeft />
              </button>
                ...
                <div className='flex justify-center in-checked: space-x-3'>
                  {
                    otp.map((digit, index)=>(
                      ...
                      className='h-12 w-12 text-center text-xl font-bold border-2 border-gray-600 rounded-lg bg-gray-700 text-white'
            ...
            <div className='mt-6 text-center'>
              ...
              </p>
              {
                ...
                <p className=''></p>
                  ...
                  <button className='text-blue-400 hover:text-blue-300 font-medium text-sm disabled:opacity-50' disabled={resendLoading} onClick={handleResendOtp}>
